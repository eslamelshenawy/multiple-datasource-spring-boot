package com.FormFieldLocalizationSecurity.secondary.dbconfig;
...
@EnableJpaRepositories(
		...
		basePackages = {"com.FormFieldLocalizationSecurity.secondary.repository"})
public class SecondaryDatabaseConnection {
    ...
    public LocalContainerEntityManagerFactoryBean secondaryEntityManagerFactory(
        ...
        return builder
        		...
        		.packages("com.FormFieldLocalizationSecurity.secondary.model")
                .build();
    }
